...
import { PopoverPlacementName } from "./components/popover/types";
...
declare global {
  ...
  interface HTMLUiPopoverElement
    extends Components.UiPopover,
      HTMLStencilElement {}
...
declare namespace LocalJSX {
  ...
  interface UiPopover {
     ...
     */
    onUiHide?: (event: CustomEvent<any>) => void;
    /**
     * Fired when the popover opens.
     */
    onUiShow?: (event: CustomEvent<any>) => void;
    /**
     * Indicates whether the popover should be open or not
     */
    opened?: boolean;
...
declare module "@stencil/core" {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      "ui-popover": LocalJSX.UiPopover &
        JSXBase.HTMLAttributes<HTMLUiPopoverElement>;
    }
  }
}
